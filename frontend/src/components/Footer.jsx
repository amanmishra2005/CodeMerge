      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12 border-b border-border/40">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <p className="text-xs text-muted leading-relaxed max-w-sm">
              All your coding profiles, handles, and solved counts merged into one unified developer graph. Level up your practice with AI-generated roadmap reviews.
            </p>
          ...
          <div className="space-y-3">
            <h4 className="text-[10px] font-bold text-text uppercase tracking-widest font-display">Product</h4>
            <ul className="space-y-2 text-xs">
              <li>
                <a href="/#features" className="text-muted hover:text-accent transition-colors duration-200">Features</a>
              </li>
              <li>
                <a href="/#how-it-works" className="text-muted hover:text-accent transition-colors duration-200">How It Works</a>
              </li>
              <li>
                <Link to="/dashboard" className="text-muted hover:text-accent transition-colors duration-200">Dashboard</Link>
              </li>
              <li>
                <Link to="/dashboard/link" className="text-muted hover:text-accent transition-colors duration-200">Platform Linker</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Platforms Column */}
          <div className="space-y-3">
            <h4 className="text-[10px] font-bold text-text uppercase tracking-widest font-display">Integrations</h4>
            <ul className="space-y-2 text-xs text-muted">
              <li className="flex items-center gap-1">
                LeetCode <span className="text-[9px] text-accent/80 font-mono">Auto</span>
              </li>
              <li className="flex items-center gap-1">
                Codeforces <span className="text-[9px] text-accent/80 font-mono">Auto</span>
              </li>
              <li className="flex items-center gap-1">
                GeeksforGeeks <span className="text-[9px] text-accent/80 font-mono">Auto</span>
              </li>
              <li className="flex items-center gap-1">
                CodeChef <span className="text-[9px] text-accent/80 font-mono">Auto</span>
              </li>
              <li className="flex items-center gap-1">
                AtCoder <span className="text-[9px] text-accent/80 font-mono">Auto</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3 col-span-2 md:col-span-1">
            <h4 className="text-[10px] font-bold text-text uppercase tracking-widest font-display">Support</h4>
            <ul className="space-y-2 text-xs">
              <li>
              ...
              <li>
                <Link to="/privacy" className="text-muted hover:text-accent transition-colors duration-200">Privacy Policy</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col gap-4 pt-8 md:flex-row md:items-center md:justify-between text-muted">
          <p className="text-[11px] font-mono leading-relaxed">
            © {new Date().getFullYear()} CodeMerge. All rights reserved. Created for competitive programming & algorithmic practice tracking.
          </p>

          <div className="flex items-center gap-4 text-xs font-mono">
            <span className="flex items-center gap-1 text-[10px] text-muted/60">
              Built with <Heart size={10} className="text-hard fill-hard animate-pulse" /> for devs
            </span>
